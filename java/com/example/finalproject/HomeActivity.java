...
import com.example.finalproject.Database.AddMotorcycle;
import com.example.finalproject.Database.FeedbackOutput;
import com.example.finalproject.Database.MigrateDatabaseActivity;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button feedbackOutputButton = findViewById(R.id.feedbackOutputButton);
        ...
        feedbackOutputButton.setOnClickListener(v -> {
            startActivity(new Intent(HomeActivity.this, FeedbackOutput.class));
        });
    ...
    private void fetchDataFromFirebase() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("10H4poBkpXc90ddrrYrjUW2gQt5MhMa9U42naKSXwHtA/motorcycles");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_home:
                ...
                break;
            case R.id.nav_addmotorcycle:
                startActivity(new Intent(this, AddMotorcycle.class));
                break;
            case R.id.nav_review:
                startActivity(new Intent(this, MotorcycleFeedback.class));
                break;
            case R.id.nav_feedbackoutput:
                startActivity(new Intent(this, FeedbackOutput.class));
                break;
            case R.id.nav_migrate:
                startActivity(new Intent(this, MigrateDatabaseActivity.class));
                break;
        }
